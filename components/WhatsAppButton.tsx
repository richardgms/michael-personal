...
export default function WhatsAppButton() {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 rounded-full bg-primary-700 animate-ping opacity-20"></div>
      <div className="absolute inset-0 rounded-full bg-primary-400 animate-ping opacity-10 delay-150"></div>
    </a>
  )
} 